 ...
 *  
 */
public class BuscaBidirecional<E extends Estado> extends Busca<E> {
    ...
    /**
     *
     * Busca a solu��o por busca em Bi-direcional.
     *                              -------------
     */
    ...
    public Nodo busca(Estado inicial) throws Exception {
    	throw new Exception("Esta classe n�o implementa a busca com um �nico par�metro"); 
    }
